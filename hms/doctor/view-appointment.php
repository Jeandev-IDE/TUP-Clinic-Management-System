                ...
                <div class="main-content">
                    <div class="wrap-content container" id="container">
                        ...
                        <section id="page-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle">View Patient's Appointment</h1>
                                </div>
                                <ol class="breadcrumb">
                                    <li>
                                        <span>Doctor</span>
                        ...
                        <div class="container-fluid container-fullw bg-white">
                            <div class="row">
                                <div class="col-md-12">
                                    <!--End Patient Details-->
                                    <h5 class="over-title margin-bottom-15">Appointment <span class="text-bold">Details</span></h5>
                                    <?php
                                    $patient_id = $_GET['patient_id'];
                                    $ret = mysqli_query($con, "select * from appointment where ID='$patient_id'");
                                    $cnt = 1;

                                    $user_query = mysqli_query($con, "select * from users where ID='$patient_id'");
                                    ...
                                    ?>
                                        ...
                                        <h5 class="over-title margin-bottom-15">Photo of <span class="text-bold">Medical </span></h5>

                                        <div>
                                            <?php
                                            //Get user image upload

                                            $get_image_qry = mysqli_query($con, "select * from uploads where user_id='$patient_id'");

                                            $checker = 0;
                                            while ($row_image = mysqli_fetch_array($get_image_qry)) {
