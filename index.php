    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;"><img src="assets\images\tup.png">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    <img class="d-block w-100" src="assets/images/slider/picture_2.png" alt="Second slide">
                    <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown"><span style="color: white" style="font-size: 100;"> Technological University of the Philippines</span> </h5>
                ...
                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/images/slider/picture_1.png" alt="Third slide">
                      <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown"><span style="color:white;"> Technological University of the Philippines</span> </h5>
    ...
    <section id="services" class="key-features department">
        <div class="container">
            <div class="inner-title">
                ...
                <h2>Our TUP Clinic System Features</h2>
                <p>Take a look at some of our system features</p>
            </div>
    ...
    <section id="about_us" class="about-us">
        <div class="row no-margin">
            ...
            <div class="col-sm-6 abut-yoiu">
                <h3>About Our Clinic Management System</h3>
<?php
